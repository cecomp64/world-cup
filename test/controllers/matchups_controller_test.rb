...
class MatchupsControllerTest < ActionController::TestCase
  ...
  test "should create matchup" do
    assert_difference('Matchup.count') do
      post :create, matchup: { awayScore: @matchup.awayScore, final: @matchup.final, homeScore: @matchup.homeScore }
    end
  ...
  test "should update matchup" do
    patch :update, id: @matchup, matchup: { awayScore: @matchup.awayScore, final: @matchup.final, homeScore: @matchup.homeScore }
    assert_redirected_to matchup_path(assigns(:matchup))
  end
